...
public class TileBitmapDrawable extends Drawable {
    ...
    public TileBitmapDrawable(ImageView parentView, BitmapRegionDecoder decoder, Bitmap screenNail) {
    ...
    public void draw(Canvas canvas) {
        ...
        final int levelCount = Math.max(1, yb.com.exchangeviewlocation.deamo.yb_crustomalbum.album.uitools.lib.MathUtils.ceilLog2(mIntrinsicWidth / (mIntrinsicWidth * minScale)));

        // sampleSize = 2 ^ currentLevel
        final int currentLevel = yb.com.exchangeviewlocation.deamo.yb_crustomalbum.album.uitools.lib.MathUtils.clamp(yb.com.exchangeviewlocation.deamo.yb_crustomalbum.album.uitools.lib.MathUtils.floorLog2(1 / scale), 0, levelCount - 1);
    ...
    private static final class InitializationTask extends AsyncTask<Object, Void, Object> {
        ...
        protected Object doInBackground(Object... params) {
            ...
            final int levelCount = Math.max(1, yb.com.exchangeviewlocation.deamo.yb_crustomalbum.album.uitools.lib.MathUtils.ceilLog2(decoder.getWidth() / (decoder.getWidth() * minScale)));
