package yb.com.exchangeviewlocation.deamo.ui;
...
public class PullToZoomListView2 extends ListView implements
	...
	public boolean onTouchEvent(MotionEvent paramMotionEvent) {
		Logger.d("mmm", "" + (0xFF & paramMotionEvent.getAction()));
		...
		case MotionEvent.ACTION_MOVE:
			...
			if (j == -1) {
				Logger.e("PullToZoomListView", "Invalid pointerId="
		...
		public void run() {
			...
			if ((!this.mIsFinished) && (this.mScale > 1.0D)) {
				...
				f2 = this.mScale - (this.mScale - 1.0F)
						* PullToZoomListView2.sInterpolator.getInterpolation(f1);
				localLayoutParams = PullToZoomListView2.this.mHeaderContainer
						.getLayoutParams();
				if (f2 > 1.0F) {
					Logger.d("mmm", "f2>1.0");
//					localLayoutParams.height = PullToZoomListView.this.mHeaderHeight;

					localLayoutParams.height = ((int) (f2 * PullToZoomListView2.this.mHeaderHeight));
					PullToZoomListView2.this.mHeaderContainer
							.setLayoutParams(localLayoutParams);
					PullToZoomListView2.this.post(this);
					return;
				}
				this.mIsFinished = true;
			}
		...
		public void startAnimation(long paramLong) {
			...
			this.mScale = ((float) (PullToZoomListView2.this.mHeaderContainer
					.getBottom()) / PullToZoomListView2.this.mHeaderHeight);
